...
export const PRODUCTS: Product[] = [
  ...
  // are per the photo that fills a single cell (the smallest unit a photo maps to).
  {
    ...
    requiresManualReview: false,
    isOutsourced: false,
    // Small prints (each cell is only 2×3) — relaxed resolution bar.
  ...
  },
  {
    sizeCode: 'mini_pair',
    productType: 'composite',
    labelInches: '2×1.5 in × 8',
    labelCm: '5×4 cm × 8',
    displayLabel: 'Mini Prints (Set of 8)',
    displayName: 'Mini Prints (Set of 8)',
    ...
    requiresManualReview: false,
    isOutsourced: false,
    // Tiny prints (each cell is only 2×1.5) — relaxed resolution bar.
    minResolution: { width: 300, height: 225 },
    recommendedResolution: { width: 600, height: 450 },
    layout: {
      ...
      printRotation: 0,
      cells: [
        { x: 0, y: 0, width: 2, height: 1.5, photoIndex: 0 },
        { x: 2, y: 0, width: 2, height: 1.5, photoIndex: 0 },
        { x: 0, y: 1.5, width: 2, height: 1.5, photoIndex: 0 },
        { x: 2, y: 1.5, width: 2, height: 1.5, photoIndex: 0 },
        { x: 0, y: 3, width: 2, height: 1.5, photoIndex: 0 },
        { x: 2, y: 3, width: 2, height: 1.5, photoIndex: 0 },
        { x: 0, y: 4.5, width: 2, height: 1.5, photoIndex: 0 },
        { x: 2, y: 4.5, width: 2, height: 1.5, photoIndex: 0 },
      ],
      editor: DEFAULT_COMPOSITE_EDITOR,
    },
  },
